...
export const ChatBubbleLeftRightIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72.372a3.75 3.75 0 0 1-3.653-3.653V15.75m6-6.49-3.72-.372a3.75 3.75 0 0 0-3.653 3.653V15.75m6-6.49V7.5c0-1.136-.847-2.1-1.98-2.193l-3.72-.372a3.75 3.75 0 0 0-3.653 3.653V15.75m-6.49-6v4.286c0 .969.616 1.813 1.5 2.097l3.72.372a3.75 3.75 0 0 0 3.653-3.653V7.5m-6.49-6V7.5c0 1.136.847 2.1 1.98 2.193l3.72.372a3.75 3.75 0 0 0 3.653-3.653V7.5" />
  </svg>
);
...
export const DatabaseIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6A2.25 2.25 0 0 1 6 3.75h12A2.25 2.25 0 0 1 20.25 6v1.5a2.25 2.25 0 0 1-2.25 2.25H6A2.25 2.25 0 0 1 3.75 7.5V6ZM3.75 12A2.25 2.25 0 0 1 6 9.75h12a2.25 2.25 0 0 1 2.25 2.25v1.5a2.25 2.25 0 0 1-2.25 2.25H6A2.25 2.25 0 0 1 3.75 13.5v-1.5ZM3.75 18A2.25 2.25 0 0 1 6 15.75h12a2.25 2.25 0 0 1 2.25 2.25v1.5A2.25 2.25 0 0 1 18 21.75H6A2.25 2.25 0 0 1 3.75 19.5v-1.5Z" />
    </svg>
);
...
export const DocumentIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m-1.5 18-3-3m0 0 3-3m-3 3h16.5M5.25 3.75h13.5" />
  </svg>
);
...
export const WandIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="m11.412 15.655 2.121-2.121m5.656 5.656-2.12-2.121m-2.122-2.121 2.122-2.121M15.655 11.412l2.121-2.121m-5.656-5.656-2.121 2.121m-2.121 2.121L5.636 5.636m5.656 5.656-2.121 2.121" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.828 3.828a1.5 1.5 0 0 1 2.122 0l4.242 4.242a1.5 1.5 0 0 1 0 2.121l-4.242 4.242a1.5 1.5 0 0 1-2.122-2.121L5.95 8.121 3.828 6.002a1.5 1.5 0 0 1 0-2.122Z" />
    </svg>
);
